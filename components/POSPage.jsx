        ...
        cart.forEach((cartItem, index) => {
          ...
          if (kitchen) {
            if (typeof kitchen === "object" && kitchen._id) {
              ...
              kitchenId = kitchen;
              kitchenData = kitchensCache.find(
                (k) => k._id.toString() === kitchen
              );
            }
          }
      ...
      setTimeout(async () => {
        ...
        setTimeout(async () => {
          ...
          if (response.success) {
            ...
            showNotification(
              response.error || "Error completing order",
              "error"
            );
          }
        }, 500);
  ...
  const handlePrintSelectedKOT = async () => {
    ...
    try {
      ...
      setTimeout(() => {
        ...
        setCurrentPrintOrder(null);
        showNotification(
          `KOT printed for ${selectedKOTItems.length} item(s)!`,
          "success"
        );
      }, 100);
    } catch (error) {
        ...
        orderData.items.forEach((item) => {
          ...
          if (item.kitchenId) {
            ...
            if (typeof item.kitchenId === "object" && item.kitchenId._id) {
              ...
              kitchenData = kitchensCache.find(
                (k) => k._id.toString() === item.kitchenId
              );
            }
          }
          ...
          >
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4">
              ...
              <div className="flex items-center gap-2 sm:gap-3 flex-wrap">
                ...
                <motion.div
                  className={`flex items-center gap-3 px-4 py-2.5 rounded-xl border-2 transition-all duration-300 shadow-md hover:shadow-lg ${
                    isSplitKOTEnabled
                        ...
                        >
                          ...
                          <div className="hidden sm:flex items-center gap-2 px-3 py-2 bg-gradient-to-r from-emerald-50 to-teal-50 border-2 border-emerald-500 rounded-xl">
                            <span className="text-2xl">
                              {selectedItemForQuantity.categoryId?.icon || "🍽️"}
                            </span>
                    ...
                    {cart.map((item) => (
                      ...
                      >
                        <div className="flex items-center gap-1.5 sm:gap-2 flex-1 min-w-0">
                          <span className="text-base sm:text-2xl flex-shrink-0">
                            {item.categoryId?.icon || "🍽️"}
                          </span>
    ...
    <div>
      ...
      <div className="flex gap-2 sm:gap-3 mb-3">
        ...
        <button
          ...
          onClick={() => {
            setOrderDetails({
              ...orderDetails,
              tableNumber: 'Family Hall',
            });
          }}
          disabled={isSubmittingOrder}
          className={`flex-1 px-4 py-2.5 sm:py-3 rounded-lg sm:rounded-xl font-bold transition-all text-xs sm:text-sm border-2 ${
            orderDetails.tableNumber === 'Family Hall' || orderDetails.tableNumber.startsWith("Family Hall")
              ? "bg-emerald-600 text-white border-emerald-600 shadow-lg"
              : "bg-white text-slate-700 border-slate-300 hover:border-emerald-400 hover:bg-emerald-50"
          } disabled:opacity-50`}
        >
      ...
      <input
        ...
        onChange={(e) => {
          ...
          const currentHall = orderDetails.tableNumber === 'Family Hall' || orderDetails.tableNumber.startsWith("Family Hall")
            ? "Family Hall" 
            : "Main Hall";
          
          setOrderDetails({
            ...orderDetails,
            tableNumber: tableNum ? `${currentHall} - ${tableNum}` : currentHall,
          });
        }}
        disabled={isSubmittingOrder}
        autoFocus
              ...
              <div className="receipt-container">
                ...
                <div className="text-center border-b-2 border-black">
                  ...
                  >
                    ...
                    <span className="font-semibold text-[18px]">
                      {currentPrintOrder.kitchenName
                        ? `[${
                            currentPrintOrder.kitchenName.match(
                              /\((.*?)\)/
                            )?.[1] || currentPrintOrder.kitchenName
                          }]`
                        : "[General Kitchen]"}
                    </span>
                  </h1>
                ...
                <div className="text-xs border-b border-dashed border-black">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span>
                      {new Date(
                        currentPrintOrder.orderDate || new Date()
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-bold uppercase">
                      {currentPrintOrder.orderType}
                    </span>
                  </div>
                  {currentPrintOrder.orderType === "dine-in" &&
                ...
                <div>
                  <h3 className="font-bold text-sm border-b border-black">
                    ITEMS:
                  </h3>
                  {currentPrintOrder.items.map((item, index) => (
                    <div
                      key={index}
                      className="flex justify-between border-b border-dashed border-gray-400"
                    >
                      <div className="flex-1">
              ...
              <div className="receipt-container">
                ...
                <div className="text-center mb-1">
                  <div className="border-4 flex justify-between items-center  border-black rounded-lg p-1 mb-1">
                    ...
                    <p className="text-2xl font-bold">
                      {currentPrintOrder.orderNumber.split("-")[1]}
                    </p>
                  </div>
                </div>
                ...
                <div className="text-sm mb-1 border-b border-dashed border-black pb-1">
                  ...
                  <div className="flex justify-between">
                    <span>Items:</span>
                    <span className="font-bold">
                      {currentPrintOrder.items.reduce(
                ...
                <div className="text-center text-[11px] border-t border-dashed border-black pt-1">
                  <p className="font-bold">
                    Preparing... Thanks for your patience!
                  </p>
                </div>
            ...
            <div className="hidden print:block print-content">
              <div className="receipt-container">
                ...
                <div className="text-xs mb-1 border-b border-dashed border-black pb-1">
                  ...
                  {currentPrintOrder.paymentMethod !== "cash" && (
                    <div className="flex justify-between">
                      <span>Payment:</span>
                      <span className="font-bold">
                        {currentPrintOrder.paymentMethod}
                      </span>
                    </div>
                  )}
                </div>
                ...
                <div className="text-xs mb-1 border-t-2 border-black pt-1">
                  ...
                  {currentPrintOrder.tax > 0 && (
                    <div className="flex justify-between">
                      <span>
                        Service Charges ({currentPrintOrder.taxPercentage}%):
                      </span>
                  ...
                  {currentPrintOrder.deliveryCharge > 0 && (
                    <div className="flex justify-between">
                      ...
                      <span>
                        ₨{currentPrintOrder.deliveryCharge.toFixed(2)}
                      </span>
                    </div>
                  )}
                ...
                <div className="text-center text-xs border-t border-dashed border-black pt-1">
                  <p className="font-bold text-[17px]">
                    {restaurantSettings?.footerMessage ||
                        ...
                        {selectedEditItemForQuantity ? (
                          ...
                          >
                            ...
                            <div className="hidden sm:flex items-center gap-2 px-3 py-2 bg-gradient-to-r from-blue-50 to-cyan-50 border-2 border-blue-500 rounded-xl">
                              <span className="text-2xl">
                                {selectedEditItemForQuantity.categoryId?.icon ||
                                  "🍽️"}
                              </span>
                              <div className="min-w-0">
                                <p className="font-bold text-slate-800 text-xs truncate max-w-[100px]">
