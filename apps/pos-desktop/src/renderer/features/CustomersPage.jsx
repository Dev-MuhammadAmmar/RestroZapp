...
export default function CustomersPage() {
  ...
  const exportCustomers = async () => {
    const result = await window.restrozapp.dataExport.csv('customers');
    if (result.ok) setSuccessMessage(`Customer CSV saved to ${result.data.path}`);
          ...
          <div className="flex flex-col gap-3 lg:gap-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3 lg:gap-4">
              ...
              <button
                ...
                className="px-4 py-2.5 lg:py-3.5 bg-white border border-gray-200 text-gray-700 rounded-lg lg:rounded-xl font-semibold flex items-center justify-center gap-2 text-sm lg:text-base"
              >
                <Download size={18} />
